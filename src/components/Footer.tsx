export const Footer = () => (
  <>
    <footer className="mx-auto mt-auto w-full bg-gray-900 px-4 py-10 sm:px-6 lg:px-8">
      <div className="text-center">
        ...
        <div className="mt-3">
          <p className="text-gray-500">
            powered by{' '}
            <a
              className="font-semibold underline hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400"
              href="https://mlnative.com"
            >
              MLnative
            </a>{' '}
          </p>
          <p className="text-gray-500">© {new Date().getFullYear()} MLnative sp z.o.o. All rights reserved.</p>
        </div>
        <div className="">
